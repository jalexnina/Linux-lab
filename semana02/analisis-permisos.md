...
Los archivos de log generalmente son escritos por el sistema o la aplicacion (como owner). Otros usuarios solo necesitan leerlos para diagnostico, no modificarlos
...
cada archivo tiene solo los permisos necesarios para su funcion, nada mas.
